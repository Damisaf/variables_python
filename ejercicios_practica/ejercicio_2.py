...
print("la suma de" , numero_1 , "+" , numero_2 , "es" , suma)

# Resta
resta = numero_1 - numero_2
print("la resta de" , numero_1 , "-" , numero_2 , "es" , resta)

# División
division  = numero_1 / numero_2
print("la division de" , numero_1 , "/" , numero_2 , "es" , division)

# Multiplicación
multiplicacion = numero_1 * numero_2
print("la multiplicacion de" , numero_1 , "*" , numero_2 , "es" , multiplicacion)
